...
const ZODIAQUE_IMAGES_BASE =
    "https://raw.githubusercontent.com/Alain31140/Agenda-data/main/zodiac/";
...
function obtenirImageZodiaque(nom) {
    const fichier = ZODIAQUE_IMAGES[nom];
    return fichier
        ? ZODIAQUE_IMAGES_BASE + fichier
        : "";
}
            ...
            <article class="accueil-carte carte-saint">
                ...
                <div class="zodiaque-bloc">
                    ...
                    <img
                        ...
                        src="${obtenirImageZodiaque(zodiaque.nom)}"
                        alt="${zodiaque.nom}"
                        loading="lazy"
                        onerror="this.remove()"
                    >
